...
folder_data = '1. Data'
files_data = ['name.txt', 'address.txt', 'phone.txt', 'nothing.txt']

folder_preprocessing = '2. Preprocessing'
files_preprocessed = ['preprocessed_name', 'preprocessed_address', 'preprocessed_phone', 'preprocessed_nothing'] # csv

folder_features = '3. Features'
files_features = ['name_features', 'address_features', 'phone_features', 'nothing_features'] # csv
